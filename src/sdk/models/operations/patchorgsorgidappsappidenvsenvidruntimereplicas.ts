...
export class PatchOrgsOrgIdAppsAppIdEnvsEnvIdRuntimeReplicasRequest extends SpeakeasyBase {
    /**
...
export class PatchOrgsOrgIdAppsAppIdEnvsEnvIdRuntimeReplicasResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
