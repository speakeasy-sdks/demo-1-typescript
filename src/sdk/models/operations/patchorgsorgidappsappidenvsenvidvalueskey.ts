...
export class PatchOrgsOrgIdAppsAppIdEnvsEnvIdValuesKeyRequest extends SpeakeasyBase {
    /**
...
export class PatchOrgsOrgIdAppsAppIdEnvsEnvIdValuesKeyResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
